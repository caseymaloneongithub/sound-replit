...
When retail or wholesale customers register accounts, they are automatically created as Stripe customers. The `stripeCustomerId` is stored in the users table for seamless future transactions. This integration:
