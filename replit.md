...
-   **Wholesale Pricing**: Supports both default pricing per unit type and customer-specific pricing overrides. Admin can set custom prices for individual customers in the wholesale unit type edit modal. If no custom price is set, the default unit type price is used.
