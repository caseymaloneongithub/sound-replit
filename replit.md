...
-   **Subscription Management**: Supports multi-product subscriptions with flexible quantities. Customers can add/remove products, delay pickups, change delivery frequency, and cancel subscriptions.
